...
//import 'package:untitled1/screens/topic_screen.dart';
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        const Text(
                          "Add both the subject/topic and time so we can remind you correctly automatically.",
                        ...
                        OutlinedButton.icon(
                          ...
                          label: const Text("Create Study Goal"),
                        ),
                      ],
                    ),
                  ),
                  ...
                  _ToolTile(
                    ...
                    onTap: () {
                      if (todaysGoals.isNotEmpty) {
                        context
                            .read<StudyProvider>()
                            .setActiveSession(todaysGoals.first);
